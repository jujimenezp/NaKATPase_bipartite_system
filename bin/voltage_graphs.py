...
ax1.set_xlim(-0.087,0.06)
ax1.text(0.07, 0.97, 'b.', transform=ax1.transAxes, fontsize=14, verticalalignment='top', backgroundcolor='None')
ax1.set_ylim(0,1)
ax1.set_box_aspect(0.6)
...
ax1.text(0.5, 1, r'$\eta_Y$', fontsize=14, transform_rotates_text=True, transform=ax1.transAxes, verticalalignment='top', backgroundcolor='None', color='blue')
ax1.text(0.5, 0.85, r'$\eta_X$', fontsize=14, transform_rotates_text=True, transform=ax1.transAxes, verticalalignment='top', backgroundcolor='None', color='red')
ax1.text(0.5, 0.62, r'$\eta$', fontsize=14, transform_rotates_text=True, transform=ax1.transAxes, verticalalignment='top', backgroundcolor='None', color='purple')
...
ax2.text(0.15, 0.18, r'$\Delta Q_X$', rotation=13, rotation_mode='anchor', transform_rotates_text=True, transform=ax2.transAxes, verticalalignment='top', backgroundcolor='None', color='red')
ax2.text(0.16, 0.61, r'$\Delta I_X$', rotation=-16, rotation_mode='anchor', transform_rotates_text=True, transform=ax2.transAxes, verticalalignment='top', backgroundcolor='None', color='orange')
ax2.text(0.42, 0.3, r'$\Delta Q_Y$', rotation=-18, rotation_mode='anchor', transform_rotates_text=True, transform=ax2.transAxes, verticalalignment='top', backgroundcolor='None', color='blue')
ax2.text(0.35, 0.96, r'$\Delta E_X$', rotation=13, rotation_mode='anchor', transform_rotates_text=True, transform=ax2.transAxes, verticalalignment='top', backgroundcolor='None', color='green')


#fig.subplots_adjust(hspace=.0)
plt.setp([a.get_xticklabels() for a in fig.axes[:-1]], visible=False)

extent = mpl.transforms.Bbox([[0.2,0.51],[0.8,0.895]]).transformed(fig.transFigure - fig.dpi_scale_trans)
fig.savefig('results/voltage_efficiencies2.png', format='png', bbox_inches=extent, dpi=300)
